package com.example.chintan.research.widget.fixheader.main;
...
import com.example.chintan.research.widget.fixheader.adapter.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
    ...
    private List<List> bodyViewTable;
    ...
    private boolean direction; //0 for y, 1 for x
    ...
    public TableFixHeaders(Context context, AttributeSet attrs) {
        ...
        this.bodyViewTable = new ArrayList<List>();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                int velocityX = (int) (velocityTracker.getXVelocity() / 8);
                int velocityY = (int) (velocityTracker.getYVelocity() / 8);
